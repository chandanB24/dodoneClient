        ...
        {data && (data.post_title || data.post_body || data.post_url ?
          <div className='card border-0 shadow-lg'>
            ...
            <div className="card-body">
              <h5 className="card-title fw-bolder" style={{ fontFamily: 'Poppins', fontWeight: 'lighter 300',}}>{data.post_title}</h5>
              <p className="card-text fw-light mb-2" style={{ fontFamily: "Poppins", fontWeight: 'Extralight 200'}}>{data.post_body}</p>
            </div>
            <div className='card-footer border-top-0 bg-white m-0 p-2'>
              <p className='card-text m-0 fw-medium' >{getTimeAgo(data.post_timestamp)}</p>
